...
public class HapticEffect_Test : MonoBehaviour
{
    ...
    public bool[] inTheZone;       //Is the stylus in the effect zone?
...
#if UNITY_EDITOR
[CustomEditor(typeof(HapticEffect_Test))]
public class HapticEffect_TestEditor : Editor
{
    override public void OnInspectorGUI()
    {
        HapticEffect_Test HE = (HapticEffect_Test)target;
        ...
        {
            HE.effectType = (HapticEffect_Test.EFFECT_TYPE)EditorGUILayout.EnumPopup("Effect Type", HE.effectType);


            switch (HE.effectType)
            {
                case HapticEffect_Test.EFFECT_TYPE.CONSTANT:
